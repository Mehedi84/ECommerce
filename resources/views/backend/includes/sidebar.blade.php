...
<div class="sidebar-wrapper" data-layout="stroke-svg">
    <div>
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('backend/assets/images/logo/logo_light.png') }}" alt=""></a>
    ...
    <nav class="sidebar-main">
        ...
        <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list">
                <a class="sidebar-link sidebar-title link-nav" href="{{ route(\Request::segment(1) . '.dashboard') }}">
            ...
            @can('setting-menu-list')
                <li class="sidebar-list"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                    ...
                    <span class="custom-sidebar-list-text">System Setting</span></a>

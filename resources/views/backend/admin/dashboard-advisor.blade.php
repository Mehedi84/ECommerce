                ...
                <div class="card-body pb-0 total-sells">
                    <div class="d-flex align-items-center gap-3">
                        <div class="flex-shrink-0"><img
                                src="{{asset('backend/assets/images/dashboard-3/icon/coin1.png')}}" alt="icon"></div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body pb-0 total-sells-2">
                    <div class="d-flex align-items-center gap-3">
                        <div class="flex-shrink-0"><img
                                src="{{asset('backend/assets/images/dashboard-3/icon/shopping1.png')}}" alt="icon">
                        </div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2">
                                <h2>78,596</h2>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body pb-0 total-sells-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="flex-shrink-0"><img
                                src="{{asset('backend/assets/images/dashboard-3/icon/sent1.png')}}" alt="icon"></div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2">
                                <h2>95,789</h2>
                                <div class="d-flex total-icon">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body pb-0 total-sells-4">
                    <div class="d-flex align-items-center gap-3">
                        <div class="flex-shrink-0"><img
                                src="{{asset('backend/assets/images/dashboard-3/icon/revenue1.png')}}" alt="icon"></div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2">
                                <h2>41,954</h2>
                                <div class="d-flex total-icon">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/1.png')}}" alt="">
                                            </div>
                                    ...
                                    <td class="customer-img">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/user/6.png')}}"
                                                    alt=""></div>
                                            <div class="flex-grow-1">
                                                <h6>Leonie Green </h6>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/2.png')}}" alt="">
                                            </div>
                                            <div class="flex-grow-1"><a href="checkout.html">
                                    ...
                                    <td class="customer-img">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/user/8.png')}}"
                                                    alt=""></div>
                                            <div class="flex-grow-1">
                                                <h6>Peter White</h6>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/3.png')}}" alt="">
                                            </div>
                                            <div class="flex-grow-1"><a href="checkout.html">
                                                    <h6>Crystal Mug</h6>
                                                </a></div>
                                    ...
                                    <td class="customer-img">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/user/7.png')}}"
                                                    alt=""></div>
                                            <div class="flex-grow-1">
                                                <h6>Ruby Yang </h6>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="{{asset('backend/assets/images/dashboard-3/4.png')}}" alt="">
                                            </div>
                                            <div class="flex-grow-1"><a href="checkout.html">

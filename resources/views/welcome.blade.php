                      ...
                      <table class="table display" id="recent-orders" style="width:100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/2.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                            ...
                            <td class="customer-img">  
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/8.png" alt=""></div>
                                <div class="flex-grow-1">
                                  <h6>Peter White</h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/3.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                            ...
                            <td class="customer-img">  
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/7.png" alt=""></div>
                                <div class="flex-grow-1">
                                  <h6>Ruby Yang </h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/4.png" alt=""></div>
                                <div class="flex-grow-1"><a href="checkout.html">
                ...
                <div class="card">
                  ...
                  <div class="card-body pt-0"> 
                    <ul class="recent-customers"> 
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/2.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Yongjae Choi</h5></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/3.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Seonil Jang</h5></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/4.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Joohee Min</h5></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/5.png" alt=""></div>
                        <div class="flex-grow-1"><a href="cart.html">
                            <h5>Soojung Kin</h5></a>
                        ...
                        <ul> 
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-primary" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>United States</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-secondary" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Romania</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-warning" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Austalia</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-tertiary" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Germany</h6>
                          ...
                          <li>
                            <div class="d-flex gap-2"> 
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-success" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Africa</h6>
                          ...
                          <li> 
                            <div class="d-flex gap-2">
                              <div class="flex-shrink-0">
                                <svg>
                                  <use class="fill-danger" href="../assets/svg/icon-sprite.svg#map-loaction"></use>
                                </svg>
                              </div>
                              <div class="flex-grow-1">
                                <h6>Europe</h6>
                    ...
                    <div class="row align-items-center">
                          ...
                          <div class="row"> 
                            <div class="col-3 product-thumbnail">
                              <div class="pro-slide-right">
                                <div class="mt-4">
                                  <div class="slide-box"><img class="img-fluid" src="../assets/images/dashboard-3/slider/1.png" alt=""></div>
                                </div>
                                <div>
                                  <div class="slide-box"><img class="img-fluid" src="../assets/images/dashboard-3/slider/2.png" alt=""></div>
                                </div>
                                <div>
                                  <div class="slide-box"><img class="img-fluid" src="../assets/images/dashboard-3/slider/3.png" alt=""></div>
                                </div>
                              </div>
                            </div>
                            <div class="col-9 px-0 product-main">
                              <div class="pro-slide-single">
                                <div> <img class="img-fluid" src="../assets/images/dashboard-3/slider/4.png" alt=""></div>
                                <div><img class="img-fluid" src="../assets/images/dashboard-3/slider/5.png" alt=""></div>
                                <div><img class="img-fluid" src="../assets/images/dashboard-3/slider/6.png" alt=""></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="product-details my-4"><a href="product-page.html">
                            <h4 class="text-truncate">Women’s Fit and Flare Knee length one Piece Dress </h4></a>
                          ...
                          <div class="countdown" id="clock-arrival" data-hours="1" data-minutes="2" data-seconds="3">
                            <ul>
                              ...
                              <li class="px-3"><span class="minutes time"></span><span class="title">Min</span></li>
                              <li class="px-3"><span class="seconds time"></span><span class="title">Sec</span></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      ...
                      <table class="table display" id="seller-month" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/9.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                    <h6>Gary Waters</h6></a></div>
                              </div>
                            </td>
                            <td>Adidas</td>
                            <td>Clothes</td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/10.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                    <h6>Edwin Hogan</h6></a></div>
                              </div>
                            </td>
                            <td>Nike</td>
                            <td>Shoes</td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/11.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/12.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">

                                            ...
                                            <div class="front">
                                                ...
                                                <ul class="bookmark-dropdown">
                                                    ...
                                                    <li class="text-center"><a
                                                            ...
                                                            href="javascript:void(0)">Add Bookmark</a></li>
                                                </ul>
                                            </div>
                                            <div class="back">
                                                <ul>
                                                    ...
                                                    <li><a class="f-w-700 d-block flip-back btn btn-primary w-100"
                                                            id="flip-back" href="javascript:void(0)">Back</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="messages">
                                        <li class="d-flex b-light1-primary gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-2/user/1.png" alt="Graph"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex b-light1-secondary gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-2/user/2.png" alt="Graph"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex b-light1-success gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-2/user/3.png" alt="Graph"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <label class="badge badge-light-success">New</label><a
                                                href="scrollspy.html">ScrollSpy</a>
                                        </li>
                                        <li><a href="breadcrumb.html">Breadcrumb</a></li>
                                        <li><a href="range-slider.html">Range Slider</a></li>
                                        <li>
                                            <label class="badge badge-light-warning">Trending</label><a
                                                href="ratios.html">Ratios</a>
                                        </li>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <label class="badge badge-light-success">New</label><a
                                                href="flash-icon.html">Flash Icons</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav" href="buttons.html">
                                        <svg class="stroke-icon">
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <label class="badge badge-light-warning">Trending</label><a
                                                href="quilleditor.html">Quill editor</a>
                                        </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-0 total-sells">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="flex-shrink-0"><img
                                                src="../assets/images/dashboard-3/icon/coin1.png" alt="icon"></div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body pb-0 total-sells-2">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="flex-shrink-0"><img
                                                src="../assets/images/dashboard-3/icon/shopping1.png" alt="icon"></div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center gap-2">
                                                <h2>78,596</h2>
                                                <div class="d-flex total-icon">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body pb-0 total-sells-3">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="flex-shrink-0"><img
                                                src="../assets/images/dashboard-3/icon/sent1.png" alt="icon"></div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center gap-2">
                                                <h2>95,789</h2>
                                                <div class="d-flex total-icon">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body pb-0 total-sells-4">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="flex-shrink-0"><img
                                                src="../assets/images/dashboard-3/icon/revenue1.png" alt="icon"></div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center gap-2">
                                                <h2>41,954</h2>
                                                <div class="d-flex total-icon">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/1.png" alt="">
                                                            </div>
                                                    ...
                                                    <td class="customer-img">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/6.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1">
                                                                <h6>Leonie Green </h6>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="status-box">
                                                            <div
                                                                class="btn background-light-success font-success f-w-500">
                                                                Succeed</div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/2.png" alt="">
                                                            </div>
                                                            <div class="flex-grow-1"><a href="checkout.html">
                                                    ...
                                                    <td class="customer-img">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/8.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1">
                                                                <h6>Peter White</h6>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="status-box">
                                                            <div
                                                                class="btn background-light-warning font-warning f-w-500">
                                                                Waiting</div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/3.png" alt="">
                                                            </div>
                                                            <div class="flex-grow-1"><a href="checkout.html">
                                                                    <h6>Crystal Mug</h6>
                                                                </a></div>
                                                    ...
                                                    <td class="customer-img">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/7.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1">
                                                                <h6>Ruby Yang </h6>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/4.png" alt="">
                                                            </div>
                                                            <div class="flex-grow-1"><a href="checkout.html">
                                                    ...
                                                    <td>
                                                        <div class="status-box">
                                                            <div
                                                                class="btn background-light-danger font-danger f-w-500">
                                                                Canceled</div>
                                                        </div>
                                                    </td>
                                                </tr>
                                ...
                                <div class="card-body pt-0">
                                    <ul class="recent-customers">
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-3/user/1.png" alt=""></div>
                                            <div class="flex-grow-1"><a href="cart.html">
                                                    <h5>Junsung Park</h5>
                                                </a>
                                                <p class="text-truncate">ID #32449<span class="text-success">Paid</span>
                                                </p>
                                            </div>
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-3/user/2.png" alt=""></div>
                                            <div class="flex-grow-1"><a href="cart.html">
                                                    <h5>Yongjae Choi</h5>
                                                </a>
                                                <p class="text-truncate">ID #95460<span
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-3/user/3.png" alt=""></div>
                                            <div class="flex-grow-1"><a href="cart.html">
                                                    <h5>Seonil Jang</h5>
                                                </a>
                                                <p class="text-truncate">ID #95468<span class="text-success">Paid</span>
                                                </p>
                                            </div>
                                            <div class="active-status active-online"></div>
                                            <div class="recent-text">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-3/user/4.png" alt=""></div>
                                            <div class="flex-grow-1"><a href="cart.html">
                                                    <h5>Joohee Min</h5>
                                                </a>
                                                <p class="text-truncate">ID #95462<span class="text-danger">
                                                        Pending</span></p>
                                            </div>
                                            <div class="active-status active-online"></div>
                                            <div class="recent-text">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="../assets/images/dashboard-3/user/5.png" alt=""></div>
                                            <div class="flex-grow-1"><a href="cart.html">
                                                    <h5>Soojung Kin</h5>
                                                </a>
                                                <p class="text-truncate">ID #34586<span class="text-success">Paid</span>
                                                </p>
                                            </div>
                                            <div class="active-status active-online"></div>
                                            <div class="recent-text">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <svg>
                                                                <use class="fill-primary"
                                                                    href="../assets/svg/icon-sprite.svg#map-loaction">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                        <div class="flex-grow-1">
                                    ...
                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="pro-slide-right">
                                                            <div class="mt-4">
                                                                <div class="slide-box"><img class="img-fluid"
                                                                        src="../assets/images/dashboard-3/slider/1.png"
                                                                        alt=""></div>
                                                            </div>
                                                            <div>
                                                                <div class="slide-box"><img class="img-fluid"
                                                                        src="../assets/images/dashboard-3/slider/2.png"
                                                                        alt=""></div>
                                                            </div>
                                                            <div>
                                                                <div class="slide-box"><img class="img-fluid"
                                                                        src="../assets/images/dashboard-3/slider/3.png"
                                                                        alt=""></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-9 px-0 product-main">
                                                        <div class="pro-slide-single">
                                                            <div> <img class="img-fluid"
                                                                    src="../assets/images/dashboard-3/slider/4.png"
                                                                    alt=""></div>
                                                            <div><img class="img-fluid"
                                                                    src="../assets/images/dashboard-3/slider/5.png"
                                                                    alt=""></div>
                                                            <div><img class="img-fluid"
                                                                    src="../assets/images/dashboard-3/slider/6.png"
                                                                    alt=""></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product-details my-4"><a href="product-page.html">
                                                    <h4 class="text-truncate">Women’s Fit and Flare Knee length one
                                                        Piece Dress </h4>
                                                </a>
                                                ...
                                                <ul class="product-color">
                                                    ...
                                                    <li class="border-secondary"><span class="bg-secondary"> </span>
                                                    </li>
                                                ...
                                                <h3 class="text-truncate">Deal of the Day From <span
                                                        class="font-secondary">$48 </span></h3>
                                                <div class="countdown" id="clock-arrival" data-hours="1"
                                                    data-minutes="2" data-seconds="3">
                                                    <ul>
                                                        <li><span class="days time"></span><span
                                                                class="title">Days</span></li>
                                                        <li><span class="hours time"></span><span
                                                                class="title">Hours</span></li>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/9.png"
                                                                    alt=""></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/10.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product-page.html">
                                                                    <h6>Edwin Hogan</h6>
                                                                </a></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/11.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product-page.html">
                                                                    <h6>Aaron Hogan</h6>
                                                                </a></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="../assets/images/dashboard-3/user/12.png"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product-page.html">
                                                                    <h6>Ralph Waters</h6>
                                                                </a></div>

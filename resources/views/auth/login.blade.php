            ...
            <div class="login-main"> 
              <form class="theme-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  <label class="col-form-label" for="inputEmailAddress">Email Address</label>
                  <input class="form-control" type="text"  id="inputEmailAddress" autocomplete="email"
                ...
                <div class="form-group">
                  <label for="inputChoosePassword" class="col-form-label">Password</label>
                  <div class="form-input position-relative">
                    <input class="form-control" type="password" name="password" id="inputChoosePassword" placeholder="Enter Password"  value="12345678">
